...
if (isset($_POST['submit'])) {
    ...
    if ($password == $cpassword) {
        ...
        if (!$result->num_rows > 0) {
            $sql = "INSERT INTO mahasiswa (username, email, password)
            ...
            if ($result) {
                ...
                echo "<script>alert('Terjadi kesalahan Saat Login')</script>";
            }
        } else {
...
<body>
    <div class="container">
        <form action="" method="POST" class="login-email">
            ...
            <p class="login-registrasi-text">Anda sudah punya akun? <a href="login.php">Login </a></p>
        </form>
    </div>
</body>
